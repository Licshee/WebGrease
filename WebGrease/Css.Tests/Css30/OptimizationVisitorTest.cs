...
namespace Css.Tests.Css30
{
    ...
    public class OptimizationVisitorTest
    {
        ...
        public void MergingRulesetsBasedOnDeclarationsTest()
        {
            ...
            MinificationVerifier.VerifyMinification(BaseDirectory, FileName6, new List<NodeVisitor> { new OptimizationVisitor { ShouldMergeBasedOnCommonDeclarations = true } });
        }
    }
}