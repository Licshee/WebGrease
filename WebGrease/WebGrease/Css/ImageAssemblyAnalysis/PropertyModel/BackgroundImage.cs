    ...
    internal sealed class BackgroundImage
    {
        ...
        internal bool UpdateTermForUrl(TermNode originalTermNode, out TermNode updatedTermNode, string updatedUrl)
        {
            if (originalTermNode == this.UrlTermNode)
            {
                ...
                updatedTermNode = new TermNode(originalTermNode.UnaryOperator, originalTermNode.NumberBasedValue, updatedUrl, originalTermNode.Hexcolor, originalTermNode.FunctionNode, originalTermNode.Comments);
                return true;
            }
        ...
        internal DeclarationNode UpdateBackgroundImageNode(string updatedUrl)
        {
            ...
            if (this.UpdateTermForUrl(originalTermNode, out newBackgroundImageTermNode, updatedUrl))
            {
                ...
                return new DeclarationNode(this.DeclarationNode.Property, new ExprNode(newBackgroundImageTermNode, originalExpr.TermsWithOperators, originalExpr.Comments), this.DeclarationNode.Prio, this.DeclarationNode.Comments);
            }
